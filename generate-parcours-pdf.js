...
const debouches = {
  "maconnerie-gros-oeuvre": { metiers: ["Macon", "Coffreur bancheur", "Tailleur de pierre", "Couvreur", "Chef d'equipe gros oeuvre", "Chef de chantier", "Conducteur de travaux BTP"], secteurs: ["BTP", "Genie civil", "Renovation du patrimoine"] },
  "second-oeuvre-finitions": { metiers: ["Plaquiste", "Peintre en batiment", "Carreleur", "Solier moquettiste", "Peintre decorateur", "Chef d'equipe finitions", "Conducteur de travaux"], secteurs: ["Amenagement interieur", "Renovation", "Construction neuve"] },
  "charpente-menuiserie-metallerie": { metiers: ["Charpentier bois", "Menuisier agenceur", "Menuisier fabricant", "Metallier", "Ferronnier d'art", "Dessinateur projeteur"], secteurs: ["Construction bois", "Menuiserie industrielle", "Metallerie"] },
  "travaux-publics-vrd": { metiers: ["Canalisateur", "Macon VRD", "Conducteur d'engins", "Grutier", "Scaphandrier", "Chef de chantier TP"], secteurs: ["Travaux publics", "Voirie", "Reseaux", "Genie civil"] },
  "etudes-conception-batiment": { metiers: ["Metreur", "Technicien d'etudes", "BIM modeleur", "Dessinateur projeteur", "Economiste de la construction", "Geometre topographe", "Charge d'affaires", "Coordinateur BIM"], secteurs: ["Bureaux d'etudes", "Cabinets d'architecture", "Maitrise d'oeuvre"] },
  "electricite-batiment-connecte": { metiers: ["Electricien d'equipement", "Monteur reseaux electriques", "Agent de maintenance", "Technicien electricien", "Domoticien"], secteurs: ["Installation electrique", "Domotique", "Smart building"] },
  "genie-climatique-thermique": { metiers: ["Installateur thermique", "Frigoriste", "Climaticien", "Technicien froid", "Technicien chauffage/ENR", "Charge d'etudes CVC"], secteurs: ["Chauffage", "Climatisation", "Froid industriel", "Energies renouvelables"] },
  "chaudronnerie-soudure": { metiers: ["Chaudronnier", "Soudeur industriel", "Tuyauteur", "Calorifugeur", "Technicien chaudronnerie", "Dessinateur projeteur tuyauterie"], secteurs: ["Industrie petroliere", "Nucleaire", "Aeronautique", "Navale"] },
  "usinage-mecanique": { metiers: ["Fraiseur", "Tourneur", "Usineur CN", "Ajusteur aeronautique", "Regleur machines-outils", "Concepteur industriel"], secteurs: ["Aeronautique", "Automobile", "Mecanique de precision", "Defense"] },
  ...
  "chimie-laboratoire": { metiers: ["Conducteur d'appareils chimie", "Technicien de fabrication", "Technicien de laboratoire", "Physicien chimiste"], secteurs: ["Industrie chimique", "Pharmaceutique", "Cosmetique", "R&D"] },
  "materiaux-composites": { metiers: ["Stratifieur composites", "Operateur composites", "Constructeur nautique", "Technicien composites"], secteurs: ["Aeronautique", "Nautisme", "Automobile", "Energie eolienne"] },
  "controle-qualite": { metiers: ["Technicien controle", "Inspecteur CND", "Inspecteur qualite aero", "Technicien fabrication additive"], secteurs: ["Aeronautique/Spatial", "Nucleaire", "Automobile"] },
  "maintenance-electronique": { metiers: ["Electromecanicien", "Cableur electronique", "Monteur cableur aero", "Technicien maintenance industrielle", "Automaticien"], secteurs: ["Maintenance industrielle", "Electronique", "Aeronautique"] },
  "mecanique-automobile": { metiers: ["Mecanicien automobile", "Mecanicien moto", "Technicien electromecanicien auto", "Controleur technique"], secteurs: ["Concessions", "Garages", "Centres auto"] },
  ...
  "commerce-negociation": { metiers: ["Conseiller commercial", "Commercial terrain", "Negociateur technico-commercial", "Assistant commercial"], secteurs: ["B2B", "B2C", "Industrie", "Services"] },
  "developpement-web": { metiers: ["Agent reconditionnement", "Developpeur web", "Developpeur fullstack", "Concepteur d'applications", "Lead developer"], secteurs: ["ESN", "Start-ups", "Agences web", "Freelance"] },
  "systemes-reseaux-cyber": { metiers: ["Technicien informatique", "Technicien reseaux", "Admin systemes et reseaux", "Admin DevOps/NetOps", "Ingenieur cybersecurite"], secteurs: ["ESN", "DSI entreprises", "Hebergeurs", "Securite IT"] },
  "design-creation-multimedia": { metiers: ["Graphiste", "Monteur audiovisuel", "Mediateur numerique", "Designer UI/UX", "Directeur artistique"], secteurs: ["Agences de communication", "Studios", "Presse/Media"] },
  "telecom-fibre": { metiers: ["Installateur fibre optique", "Technicien fibre FTTH", "Charge d'etudes telecom", "Chef d'equipe fibre"], secteurs: ["Operateurs telecom", "Sous-traitants fibre", "Data centers"] },
  "transport-conduite": { metiers: ["Conducteur PL/SPL", "Conducteur de bus", "Exploitant transport", "Gestionnaire operations", "Organisateur transport international"], secteurs: ["Transport routier", "Logistique", "Transport voyageurs"] },
  "logistique-entreposage": { metiers: ["Agent magasinier", "Cariste", "Preparateur de commandes", "Technicien logistique", "Responsable d'entrepot"], secteurs: ["E-commerce", "Grande distribution", "Industrie"] },
  "comptabilite-gestion": { metiers: ["Comptable assistant", "Secretaire comptable", "Gestionnaire comptable", "Gestionnaire de paie", "Assistant immobilier", "Responsable de structure"], secteurs: ["Cabinets comptables", "PME/TPE", "Immobilier"] },
  "secretariat-assistance": { metiers: ["Secretaire assistant(e)", "Secretaire medical(e)", "Assistant(e) de direction", "Office manager"], secteurs: ["Toute entreprise", "Sante", "Juridique"] },
  "sante-medico-social": { metiers: ["Aide a domicile", "Accompagnant educatif et social", "Auxiliaire prothese dentaire", "Agent de proprete", "Opticien vendeur"], secteurs: ["EHPAD", "Domicile", "Hopitaux", "Laboratoires dentaires"] },
  "mediation-relation-client": { metiers: ["Agent de mediation", "Teleconseiller", "Mediateur social", "Manager relation client"], secteurs: ["Services publics", "Centres d'appels", "Collectivites"] },
  ...
  "environnement-energie": { metiers: ["Agent valorisation dechets", "Operateur amiante", "Paysagiste", "Horticulteur", "Technicien traitement eaux", "Charge d'etudes thermiques"], secteurs: ["Environnement", "Recyclage", "Depollution", "Energie renouvelable"] },
  "securite-surveillance": { metiers: ["Agent de securite", "Operateur videoprotection", "Technicien securite incendie", "Chef d'equipe securite"], secteurs: ["Societes de securite", "Grande distribution", "Evenementiel"] },
